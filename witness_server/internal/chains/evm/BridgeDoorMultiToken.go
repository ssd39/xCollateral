...
type XChainTypesBridgeConfig struct {
	LockingChainDoor  common.Address              `json:"lockingChainDoor"`
	LockingChainIssue XChainTypesBridgeChainIssue `json:"lockingChainIssue"`
	IssuingChainDoor  common.Address              `json:"issuingChainDoor"`
	IssuingChainIssue XChainTypesBridgeChainIssue `json:"issuingChainIssue"`
}
...
//
// Solidity: event CreateBridge(bytes32 indexed bridgeKey, address lockingChainDoor, address lockingChainIssueIssuer, string lockingChainIssueCurency, address issuingChainDoor, address issuingChainIssueIssuer, string issuingChainIssueCurency)
